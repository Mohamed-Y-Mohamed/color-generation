...
export function ComponentStyleGenerator({
  themes,
  selectedTheme,
}: ComponentStyleGeneratorProps) {
  const [selectedFormat, setSelectedFormat] = useState<"css" | "json" | "html">(
    "css"
  );
      ...
      <Card className="mt-12">
        ...
        <CardContent>
          <p className="text-muted-foreground">
            Select a theme to generate component styles
          </p>
        </CardContent>
      </Card>
    );
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <Button
                    ...
                    variant="ghost"
                    onClick={() =>
                      copyToClipboard(componentCSS.secondaryButton)
                    }
                    title="Copy CSS"
                  >
                    <Copy className="w-4 h-4" />
                  ...
                  >
                    ...
                    <Button
                      ...
                      onClick={() =>
                        copyToClipboard(
                          componentCSS.alerts[
                            alert.type as keyof typeof componentCSS.alerts
                          ]
                        )
                      }
                      className="ml-auto"
